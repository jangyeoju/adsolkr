      ...
      <ThemeProvider theme={theme}>
        ...
        <ProductWrap>
          ...
          <div className="content-wrap2">
            <h2 className="sub-title">실내 다중 이용시설 방역로봇 CLIBO</h2>
            <p className="sub-title-detail">
              사람들이 생활하는 모든 환경에서 미세먼지와 바이러스, <br />
              세균으로로부터 사람들을 보호합니다.
            </p>
          ...
          <div className="content-wrap background-img">
            <Container>
              ...
              <p>
                실내다중이용시설내의 접촉바이러스, 공기 살균,
                <br />
                공기 정화를 수행합니다. 배터리와 필터를 자동 교체합니다.
                <br />
                생산비용이 절감되고, 기간이 단축됩니다.
                <br />
                고객의 요구에 대응 가능합니다.
              </p>
              ...
              <div className="content-wrap" id="sec2">
                <div className="content-title-wrap">
                  ...
                  <div className="content-info-list">
                    ...
                    <ul className="content-detail-info-list">
                      <li>
                        인체에 무해한 살균 광원을 통한 외부 표면 및 공기 살균
                      </li>
                      <li>
                        살균 효과가 높은 UV-C(자외선) 살균 광원을 통한 내부 공기
                        살균
                      </li>
                  ...
                  <div className="content-info-list">
                    ...
                    <div className="dp-wrap">
                      ...
                      <ul className="content-detail-info-list">
                        ...
                        <li>
                          금형 최소화 및 공용 부품 사용시 나사 자국 하나 없는
                          외함
                        </li>
                        <li>
                          모듈러 구조 및 생산성 향상, 관리를 위한 원터치식 결합
                          방식
                        </li>
                      </ul>
                    </div>
          ...
          <SolutionWrap>
            <ContainerWrap>
              ...
              <p>
                공공기관인 학교, 병원, 공항과 렌탈서비스 대상인 병원, 요양원,
                산후조리원
                <br />
                일판 판매 대상인 물류센터, 식품 공장, 육가공 공장, 축사 등에서
                <br />
                표면 살균 및 청정을 통해 대기질을 개선하고 시민의 안전을 지키기
                위해 사용됩니다.
              </p>
