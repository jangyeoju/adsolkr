...
export default function NowPageView({ awardImages }) {
            ...
            <ContainerWrap>
              ...
              <ul className="priemier-content">
                <li>
                  ...
                  <h4>
                    Selected for the Ultra-Competitive Startup 1000 Project
                  </h4>
                  <p>
                    An ultra-competitive startup that proves its top-tier
                    technology
                  </p>
                </li>
                <li>
