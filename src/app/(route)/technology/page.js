        ...
        <TechnologyWrap>
            ...
            <ContainerWrap>
              <ul className="technology-title">
                <li>
                  <h5>01</h5>
                  <h2>
                    외함기술 <strong className="montserrat">AHS</strong>
                  </h2>
                  <img src="/img/technology/Arrow.svg" />
                </li>
                <li>
                  <p>
                    금형 없이 공용 부품과 원터치 결합 방식으로 제작 비용을
                    절감하고, <br />
                    생산 기간을 단축 모듈화 구조로 다양한 디바이스에 대응이
                    가능하고 <br />
                    고객 요청에 맞게 대응이 가능 디자인적 요소를 적용하여 <br />
              ...
              <ContainerWrap>
                <ul className="technology-title">
                  <li>
                    <h5>02</h5>
                    <h2>
                      로봇 기술 <strong className="montserrat">ARS</strong>
                    </h2>
                  ...
                  <li>
                    <p>
                      ...
                      관리 <br />
                      인력 없이 필터 및 배터리를 자동으로 교체하는 자동 스테이션
                      기술
                    </p>
                  </li>
                </ul>
          ...
          <TechnologySection3 id="sec3">
            <ContainerWrap>
              <ul className="technology-title">
                <li>
                  <h5>03</h5>
                  <h2>
                    광원 기술 <strong className="montserrat">ASS</strong>
                  </h2>
                  <img src="/img/technology/Arrow.svg" />
                </li>
                <li>
                  <p>
                    인체에 무해한 특수한 원자외선 파장대의 살균 광원
                    수납식(개폐식)
                    <br />
                    자외선 광원으로 안전성 확보
                  </p>
            ...
            <div className="rays-wrap" id="tech2">
              <div className="rays-banner">
                <ContainerWrap>
                  <h2>원자외선 VS 자외선</h2>
                  <p>
                    인체에 무해한 원자외선(Far UV-C) 광원을 사용하여 안전합니다.
                  </p>
            ...
            <div className="thesis-wrap" id="tech3">
              <h2 className="sub-title">학계 논문</h2>
              <ContainerWrap>
...
const TechnologyWrap = styled(Box)`
  ...
  .technology-info-box {
    ...
    li:nth-of-type(2) {
      ...
      box-shadow: 0 0 20px rgba(211, 206, 255, 0.3);
      margin-bottom: 10rem;
    }
  }
